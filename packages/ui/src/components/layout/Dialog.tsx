 ...
 * Project Repository: https://github.com/shadcn-ui/ui/blob/main/apps/www/registry/new-york/ui/dialog.tsx
 *
 * Date of Import: 16 August 2024
 * -----------------------------------------------------------------------------
...
const DialogContent = React.forwardRef<
	...
	React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
		portalProps?: React.ComponentPropsWithRef<typeof DialogPrimitive.Portal>;
		overlayProps?: React.ComponentPropsWithoutRef<typeof DialogPrimitive.Overlay>;
	}
>(({ className, children, portalProps = {}, overlayProps, ...props }, ref) => (
